from day14 import Reaction, Element, FuelFactory
...
def test_part1_example1():
    ...
    expected = 31
    reactions = [Reaction(line) for line in test_input]
    factory = FuelFactory(reactions)
    result = factory.get_costs_for(Element("FUEL", 1))
...
def test_part2_example1():
    ...
    result = factory.get_fuel_for(target)
    assert result == expected
